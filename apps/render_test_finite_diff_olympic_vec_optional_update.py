...
def cmd_template():
    ...
    cmd = f"""python approx_gradient.py --shader test_finite_diff_olympic_vec_optional_update --init_values_pool apps/example_init_values/test_finite_diff_olympic_tilt_80_param_init_values_pool_extra.npy --metrics 5_scale_L2 --render_size 960,480 --is_color --smoothing_sigmas 0.5,1,2,5 --gt_file olympic_rgb.png --multi_scale_optimization --alternating_times 5"""
